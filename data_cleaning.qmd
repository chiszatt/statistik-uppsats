...
plasma_bl <- plasma_data %>% filter(VISCODE %in% c("bl", "v03", "4_bl"))
amyloid_bl <- amyloid_data %>% filter(VISCODE %in% c("bl", "v03", "4_bl"))
diagnosis_bl <- diagnosis_data %>% filter(VISCODE %in% c("bl", "v03", "4_bl"))
...
plasma_cols <- colnames(merged)[grepl("pT|AB|NfL|GFAP", colnames(merged))]
