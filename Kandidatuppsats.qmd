...
The longitudinal component of the joint model is specified by linear mixed-effects model (**LAIRD & WAIRE**), which captures both population-level trends and individual variability in biomarker trajectories.
...
Following the notation of Rizopoulos (p. 54), the biomarker process for ptau-181 and NfL can be considered such that:
