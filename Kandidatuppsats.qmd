...
Values of p-tau181 ranged from a minimum of 0.4 to a maximum of 451.4. The median was 16.3, with the first quartile at 11.1 and the third quartile at 23.6. Similarly, the values of NfL ranged from a minimum of 6.4 to a maximum of 408, with a median of 37.9, a first quartile of 27.8, and a third quartile of 52.5. In other words, both NfL and p-tau181 exhibited highly right-skewed distributions.

The log-transformation of p-tau181 produced a distribution that more closely approximated a normal distribution, with a greater concentration of observations around the center. However, some residual left-skewness remained, although it was not considered substantial.

![](figures/hist_log_p_tau.png){width="400"}

In comparison, the distribution of NfL more closely approximated a normal distribution after log-transformation. The observations appeared less dispersed and were more concentrated around the center of the distribution.

![](figures/hist_log_nfl.png){width="400"}

The two log-transformed biomarkers were therefore considered appropriate for inclusion in the statistical models.
...
Plotting the residuals against the fitted values for the LME model of p-tau181 showed no clear evidence of heteroskedasticity (see Appendix 1). The slight deviations in the tails of the Q-Q plot were also not considered to be of concern (see Appendix 2). The same pattern was observed for the LME model of NfL, where plotting the residuals against the fitted values showed even less evidence of heteroskedasticity compared to the corresponding plot for p-tau181 (see Appendix 3). The Q-Q plot showed similar results to that of p-tau181 (see Appendix 4). Consequently, both models were considered to provide a reasonable fit to the data, suggesting that they are suitable for use within the joint modeling framework.
...
Additionally, convergence of the models was assessed by examining the $\widehat{R}$ values of the survival outcome and the longitudinal outcome in each joint model, presented in table 4.
...
## Appendix 1: fitted values versus residuals from the LME model for p-tau181

![](figures/residuals_vs_fitted_ptau.png){width="400"}

## Appendix 2: Q-Q plot of the LME model for p-tau181

![](figures/qq_ptau.png){width="400"}

## Appendix 3: fitted values versus residuals from the LME model for NfL

![](figures/residuals_vs_fitted_nfl.png){width="400"}

## Appendix 4: Q-Q plot of the LME model for NfL
