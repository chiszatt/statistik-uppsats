...
Additionally, individuals with AD-dementia are either considered as right-censored, meaning that they do not reach the event during the follow-up period, or as interval-censored, meaning that the exact date of the event is unknown (Kleinbaum & Klein, 2012, pp. 7, 286). Due to the diagnoses being made yearly, meaning that the exact date of transition to dementia can only be approximated, participants in this study are considered as right-censored.
...
The concordance index ($C$ index) is an evaluation measure for the performance of survival models. All pairs of individuals are selected, and the $C$ index evaluates the proportion of pairs who are concordant, where the individual with a higher cumulative incidence, calculated as $1 - S(t)$, has the shorter time-to-event (Park et al., 2021, p. 1701). It will be considered as an initial evaluation metric for the different Cox PH models estimated in this study.
