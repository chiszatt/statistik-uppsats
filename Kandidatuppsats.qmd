...
Thus, the question arises as to which modeling approach is best suited for predicting progression to AD dementia when considering the added value of longitudinal biomarker information. Few studies have systematically compared the previously mentioned modeling approaches within a unified framework in AD, specifically focusing on plasma biomarkers such as NfL and p-tau. **Frågan är även om NfL alltid ger bättre prediction än P-tau181, oavsett metod.**
