...
AD pathophysiology has typically been detected by positron emission topography (PET) to confirm the presence and degree of amyloid plaques in the brain or by quantification of biomarkers implicated in AD pathology in cerbrospinal fluid (CSF) (Mattson, N., 2017, p. 557). The former method involves radiation and the latter requires a lumbar puncture in order to extract the CSF. Breakthroughs in technology (Rissin et al., 2010) have allowed for quantification of biomarkers at much smaller concentrations than previous methods, typically being up to 1000 times more sensitive (Chang et al., 2012, pg. 2). Using this method, biomarkers can be detected peripherally from their origin where concentrations are much smaller. These advances mean that more invasive procedures can be substituted with blood tests. ***WHO published a report in 2024 highlighting the promising progress made in recent years regarding the use of blood-based biomarkers to support AD diagnosis (WHO, p. 6)***

-- PREVIOUS PTAU SECTION —
...
These two blood-based biomarkers, along with various other biomarkers and clinical measures related to Alzheimer’s disease, are the main focus of the *Alzheimer’s Disease Neuroimaging Initiative* (ADNI). Blood samples from the ADNI cohort have been retrospectively analysed using the recently developed method in order to quantify the levels of ptau-181 and NfL in 2020 and 2018 respectively (Zetterberg & Blennow, 2020; Blennow, 2018).

***Since 2004, researchers across more than 60 clinical sites in the USA and Canada have continuously collected and analyzed data throughout the different phases of the study. The current phase, ADNI4, began in 2022 and is expected to be completed in 2027. Its main goals are to provide open-access data to researchers worldwide and to improve the diagnosis of Alzheimer’s disease (ADNI, n.d.)***
