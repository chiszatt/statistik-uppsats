...
In the joint model of longitudinal and survival data, the hazard function at time $t$ is directly dependent on the value of the biomarker level at time $t$. In Alzheimer’s disease research specifically, biomarkers such as p-tau181 and NfL are measured repeatedly over time, and their relationship between their trajectories and disease progression is analysed.
