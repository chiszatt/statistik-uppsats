...
Finally, a correlation matrix was computed for the numerical variables in the in-sample dataset to assess potential multicollinearity, and the results are presented in Appendix X. The correlations were generally low to moderate, indicating no issues with multicollinearity and supporting their inclusion in the models.
