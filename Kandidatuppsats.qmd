...
```{r}
knitr::kable(readRDS("tables/summary_jlcmm_ptau_full.rds")) %>%
  kable_styling(latex_options = c("hold_position", "scale_down"))
```
...
```{r}
knitr::kable(readRDS("tables/summary_jlcmm_nfl_full.rds")) %>%
  kable_styling(latex_options = c("hold_position", "scale_down"))
```
...
```{r}
knitr::kable(readRDS("tables/summary_jlcmm_ptau_nfl_full.rds")) %>%
  kable_styling(latex_options = c("hold_position", "scale_down"))
```
