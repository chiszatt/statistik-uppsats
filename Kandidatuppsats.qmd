...
Additionally, predictive performance was evaluated using the time-dependent Brier score, with Figure ? providing an initial overview of the Cox models across the follow-up period.
