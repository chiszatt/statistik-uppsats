...
Various models have utilised longitudinal p-tau181 and NfL values with the aim of modeling AD progression, however, the question arises as to which of these modeling approaches has greatest predictive performance. Few studies have systematically compared the previously mentioned modeling approaches within a unified framework in AD research, specifically focusing on plasma biomarkers such as NfL and p-tau. Across these different modelling approaches, it is also of interest to examine whether NfL, p-tau181 or a combination of the biomarkers gives the best predictive perfomance.
