...
### Time-dependent AUC curves for all JM

![](figures/q2_auc_jm.png){width="400"}

### Time-dependent AUC curves for all JLCMM

![](figures/q2_auc_lcjm.png){width="400"}

### Time-dependent Brier score curves for all JM

![](figures/q2_brier_jm.png){width="400"}

### Time-dependent Brier score curves for all JLCMM
