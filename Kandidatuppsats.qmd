...
kable_standard(readRDS("tables/table_ph_final1.rds"))
```
...
## Appendix X: Cox model comparison table when including participants with at least one biomarker 
...
## Appendix X: joint model comparison table when including participants with at least one biomarker 
