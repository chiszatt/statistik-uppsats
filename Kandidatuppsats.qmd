...
To assure the robustness of these results, sensitivity analyses were also assessed,
...
Estimating the JLCMMs with the extended cohort of individuals with at least one biomarker measurement resulted in similar conclusions regarding
...
# kable_standard(readRDS("tables/tables/results_table_AUC_first_duplicate.rds"))
```
...
# kable_standard(readRDS("tables/tables/results_table_Brier_first_duplicate.rds"))
```
