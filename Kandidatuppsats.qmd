...
where $p_t$ is the predicted probability of an event and $o_t$ is the observed outcome. The Brier score takes values from 0 to 1, where a score closer to 0 is given to a model with better predictive ability (Seo Young Park, pg. 1704). **\*\*TIME DEPENDENT BRIER SCORE\*\***
