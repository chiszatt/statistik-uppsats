...
Recent research has applied a range of statistical models to predict progression to dementia using biomarker data. For instance, a 2021 study used a Cox proportional hazards (Cox PH) model with baseline p-tau181, alongside covariates such as age and sex. The study included a total of 767 participants from the ADNI database, comprising cognitively unimpaired individuals, individuals with mild cognitive impairment (MCI), and individuals with dementia. Predictive performance was evaluated using Receiver Operating Characteristic (ROC) analysis at a fixed prediction horizon, yielding an area under the curve (AUC) of 0.78. This suggests that the model demonstrated good discriminative ability in identifying individuals who later developed dementia during follow-up (Wang et al., 2021, p. X). 

Similarly, a large population-based study of 2148 dementia-free older adults applied a single multivariable Cox proportional hazards model including p-tau181, p-tau217, neurofilament light (NfL), and GFAP as simultaneous baseline predictors, to examine their predictive value for progression to all-cause and Alzheimer’s disease dementia. Predictive performance was assessed using a fixed 10-year prediction horizon, where the AUC was calculated based on dementia occurrence within 10 years. Within this framework, the presence of elevated values of one, two, or three biomarkers yielded AUC values of 74.3%, 77.0%, and 81.3% for AD-dementia, respectively, demonstrating progressively improved discriminative ability for identifying individuals who subsequently developed AD-dementia (Grande et al., 2025, p. ?).
