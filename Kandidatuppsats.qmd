...
![](figures/hist_p_tau.png){width="400"}
...
![](figures/hist_nfl.png){width="400"}
...
KODEN NEDAN SKA EJ TAS BORT, BEHÖVS VARA KVAR FÖR ATT LÄSA IN TABELLERNA (men den ovan för grafer kan tas bort efter att man har gjort den, krävs bara att man skriver de specifika texterna)
